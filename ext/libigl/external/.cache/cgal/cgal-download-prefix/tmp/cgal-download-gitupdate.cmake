...
execute_process(
  COMMAND "/usr/bin/git" show-ref "f7c3c8212b56c0d6dae63787efc99093f4383415"
  WORKING_DIRECTORY "/home/qp-hiro/SpatialLinkageCam/ext/libigl/cmake/../external/cgal"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/qp-hiro/SpatialLinkageCam/ext/libigl/cmake/../external/cgal'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/qp-hiro/SpatialLinkageCam/ext/libigl/cmake/../external/cgal'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
