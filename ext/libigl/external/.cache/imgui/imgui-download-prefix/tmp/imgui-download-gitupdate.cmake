...
execute_process(
  COMMAND "/usr/bin/git" show-ref "61b19489f1ba35934d9114c034b24eb5bff149e7"
  WORKING_DIRECTORY "/home/qp-hiro/SpatialLinkageCam/ext/libigl/cmake/../external/imgui"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/qp-hiro/SpatialLinkageCam/ext/libigl/cmake/../external/imgui'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/qp-hiro/SpatialLinkageCam/ext/libigl/cmake/../external/imgui'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
